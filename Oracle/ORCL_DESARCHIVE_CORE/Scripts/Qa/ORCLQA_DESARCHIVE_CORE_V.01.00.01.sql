...
CREATE UNIQUE INDEX SCH_ORCLQA_DESARCHIVE_CORE.IDX_HISTORICO_TARIFA ON
    SCH_ORCLQA_DESARCHIVE_CORE.HISTORICO_TARIFA (
        CODIGO
    ASC );
...
CREATE TABLE SCH_ORCLQA_DESARCHIVE_CORE.USUARIO_POR_BODEGA (
    ID_BODEGA                  NUMBER(19) NOT NULL,
    CODIGO_TIPO_IDENTIFICACION NVARCHAR2(1000),
    NUMERO_IDENTIFICACION      NVARCHAR2(1000)
);

ALTER TABLE SCH_ORCLQA_DESARCHIVE_CORE.USUARIO_POR_BODEGA ADD CONSTRAINT PK_USU_BDG
	PRIMARY KEY ( ID_BODEGA, CODIGO_TIPO_IDENTIFICACION, NUMERO_IDENTIFICACION );
