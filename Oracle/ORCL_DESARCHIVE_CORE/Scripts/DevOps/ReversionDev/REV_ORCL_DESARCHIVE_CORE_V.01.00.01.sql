/*
-------------------------------------------------------------------------------------------------------------------------------
-- OBJETIVO                  : Reversion del script ORCL_DESARCHIVE_CORE_V.01.00.01.sql
...
PROMPT
DROP TABLE SCH_ORCL_DESARCHIVE_CORE.JUZGADO;
PROMPT
PROMPT *** Borrado de secuencia SEQ_JUZGADO
PROMPT
DROP SEQUENCE SCH_ORCL_DESARCHIVE_CORE.SEQ_JUZGADO;
PROMPT
PROMPT *** Borrado de tabla ESPECIALIDAD
PROMPT
DROP TABLE SCH_ORCL_DESARCHIVE_CORE.ESPECIALIDAD;
PROMPT
PROMPT *** Borrado de secuencia SEQ_ESPECIALIDAD
PROMPT
DROP SEQUENCE SCH_ORCL_DESARCHIVE_CORE.SEQ_ESPECIALIDAD;
PROMPT
PROMPT *** Borrado de tabla TIPO_PROCESO
PROMPT
DROP TABLE SCH_ORCL_DESARCHIVE_CORE.TIPO_PROCESO;
PROMPT
PROMPT *** Borrado de secuencia SEQ_TIPO_PROCESO
PROMPT
DROP SEQUENCE SCH_ORCL_DESARCHIVE_CORE.SEQ_TIPO_PROCESO;
PROMPT
PROMPT *** Borrado de tabla ANIO
PROMPT
DROP TABLE SCH_ORCL_DESARCHIVE_CORE.ANIO;
PROMPT
PROMPT *** Borrado de secuencia SEQ_ANIO
PROMPT
DROP SEQUENCE SCH_ORCL_DESARCHIVE_CORE.SEQ_ANIO;
