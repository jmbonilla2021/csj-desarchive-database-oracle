...
CREATE TABLESPACE ORCLQA_DESARCHIVE_CORE_DATA DATAFILE '&TABLESPACEDATA' SIZE 10M AUTOEXTEND ON NEXT 10M MAXSIZE UNLIMITED;
CREATE TABLESPACE ORCLQA_DESARCHIVE_CORE_IDX  DATAFILE '&TABLESPACEIDX'  SIZE 10M AUTOEXTEND ON NEXT 10M MAXSIZE UNLIMITED;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_CORE.SEQ_BODEGA START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_CORE.SEQ_JURISDICCION START WITH 1 CACHE 100 ORDER;
