...
COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_CORE_PRE.NOVEDAD.ID_PROFESIONAL_BODEGA IS
    'CAMPO QUE ALMACENA EL IDENTIFICADOR DEL PROFESIONAL DE LA BODEGA.';
...
COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_CORE_PRE.TIPO_PROCESO.ES_VISIBLE_SITIO_WEB_EXT IS
    'CAMPO QUE ALMACENA SI EL TIPO DE PROCESO ES VISIBLE O NO VISBLE EN EL SITIO WEB.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_CORE_PRE.TIPO_PROCESO.ES_DE_PAGO_SITIO_WEB_EXT IS
...
COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_CORE_PRE.TIPO_PROCESO.ID_JUZGADO IS
    'CAMPO QUE ALMACENA EL IDENTIFICADOR DEL JUZGADO.';
...
ALTER TABLE SCH_ORCL_DESARCHIVE_CORE_PRE.TIPO_PROCESO
