...
CREATE UNIQUE INDEX SCH_ORCL_DESARCHIVE_CORE_PRE.IDX_HISTORICO_TARIFA ON
    SCH_ORCL_DESARCHIVE_CORE_PRE.HISTORICO_TARIFA (
        CODIGO
    ASC );
...
ALTER TABLE SCH_ORCL_DESARCHIVE_CORE_PRE.USUARIO_POR_BODEGA ADD CONSTRAINT PK_USU_BDG
