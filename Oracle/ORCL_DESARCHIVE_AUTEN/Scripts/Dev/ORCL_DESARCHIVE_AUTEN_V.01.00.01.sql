...
ALTER TABLE SCH_DESARCHIVE_AUTEN.USUARIO DROP CONSTRAINT FK_DTU_USU;
ALTER TABLE SCH_DESARCHIVE_AUTEN.DETALLE_USUARIO ADD CONSTRAINT FK_USU_DTU FOREIGN KEY ( ID_USUARIO ) REFERENCES USUARIO ( ID_USUARIO );
CREATE UNIQUE INDEX SCH_DESARCHIVE_AUTEN.IDX_USU_DTU ON SCH_DESARCHIVE_AUTEN.DETALLE_USUARIO (ID_USUARIO ASC );

CREATE UNIQUE INDEX SCH_DESARCHIVE_AUTEN.IDX_CRD_IDUSUARIO ON SCH_DESARCHIVE_AUTEN.CREDENCIAL (ID_USUARIO ASC );
