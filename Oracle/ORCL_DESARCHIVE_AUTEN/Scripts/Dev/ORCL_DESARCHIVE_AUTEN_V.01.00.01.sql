...
CREATE TABLE SCH_ORCL_DESARCHIVE_AUTEN.PROCESO (
    ID_PROCESO NUMBER(19) NOT NULL,
...
CREATE UNIQUE INDEX SCH_ORCL_DESARCHIVE_AUTEN.IDX_CODIGO_PROCESO ON
    SCH_ORCL_DESARCHIVE_AUTEN.PROCESO (
        CODIGO
    ASC );

ALTER TABLE SCH_ORCL_DESARCHIVE_AUTEN.PROCESO ADD CONSTRAINT PK_PRC PRIMARY KEY ( ID_PROCESO );
...
ALTER TABLE SCH_ORCL_DESARCHIVE_AUTEN.PARAMETRO
    ADD CONSTRAINT FK_PRC_PRM FOREIGN KEY ( ID_PROCESO )
        REFERENCES SCH_ORCL_DESARCHIVE_AUTEN.PROCESO ( ID_PROCESO );
...
CREATE SEQUENCE SCH_ORCL_DESARCHIVE_AUTEN.SEQ_PARAMETRO START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCH_ORCL_DESARCHIVE_AUTEN.SEQ_PROCESO START WITH 1 CACHE 100 ORDER;

CREATE OR REPLACE TRIGGER SCH_ORCL_DESARCHIVE_AUTEN.TRG_PROCESO BEFORE
    INSERT ON SCH_ORCL_DESARCHIVE_AUTEN.PROCESO
    FOR EACH ROW
    WHEN ( NEW.ID_PROCESO IS NULL )
BEGIN
    :NEW.ID_PROCESO := SCH_ORCL_DESARCHIVE_AUTEN.SEQ_PROCESO.NEXTVAL;
END;
/
