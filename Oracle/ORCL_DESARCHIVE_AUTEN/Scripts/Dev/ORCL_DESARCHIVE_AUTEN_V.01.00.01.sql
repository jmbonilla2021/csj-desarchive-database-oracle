...
CREATE SEQUENCE SCH_ORCL_DESARCHIVE_AUTEN.SEQ_PROCESO START WITH 1 CACHE 20 ORDER;

CREATE OR REPLACE TRIGGER SCH_ORCL_DESARCHIVE_AUTEN.TRG_PROCESO BEFORE
    INSERT ON SCH_ORCL_DESARCHIVE_AUTEN.PROCEDIMIENTO
    FOR EACH ROW
    WHEN ( NEW.ID_PROCEDIMIENTO IS NULL )
BEGIN
    :NEW.ID_PROCEDIMIENTO := SCH_ORCL_DESARCHIVE_AUTEN.SEQ_PROCESO.NEXTVAL;
END;
/
