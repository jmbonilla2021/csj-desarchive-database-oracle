...
COMMENT ON TABLE SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS IS
    'TABLA QUE ALMACENA LA INFORMACIÓN DE LAS APLICACIONES INTERNAS.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS.ID_APPS_INT IS
    'CAMPO QUE ALMACENA EL IDENTIFICADOR ÚNICO DE LA APLICACIÓN INTERNA.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS.NOMBRE IS
    'CAMPO QUE ALMACENA EL NOMBRE DE LA APLICACIÓN INTERNA.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS.HOST IS
    'CAMPO QUE ALMACENA EL HOST (DIRECCIÓN WEB) DE LA APLICACIÓN INTERNA.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS.PORT IS
    'CAMPO QUE ALMACENA EL PUERTO DE LA APLICACIÓN INTERNA.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS.USERNAME IS
    'CAMPO QUE ALMACENA EL NOMBRE DEL USUARIO DE LA APLICACIÓN INTERNA.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS.PASSWORD IS
    'CAMPO QUE ALMACENA LA CONTRASEÑA DEL USUARIO DE LA APLICACIÓN INTERNA.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS.DETALLE IS
    'CAMPO QUE ALMACENA EL DETALLE O LA DESCRIPCIÓN DE LA APLICACIÓN INTERNA.';

COMMENT ON COLUMN SCH_ORCL_DESARCHIVE_AUTEN.APPS_INTERNAS.ES_ACTIVO IS
