...
CREATE SEQUENCE SCH_ORCLQA_DESARCHIVE_AUTEN.SEQ_PROCESO START WITH 1 CACHE 20 ORDER;
...
BEGIN
    :NEW.ID_PROCEDIMIENTO := SCH_ORCLQA_DESARCHIVE_AUTEN.SEQ_PROCESO.NEXTVAL;
END;
/
