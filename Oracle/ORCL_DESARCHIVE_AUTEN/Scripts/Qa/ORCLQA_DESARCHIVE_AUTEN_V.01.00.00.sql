...
CREATE TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_grupo (
    id_estado_grupo NUMBER(19) NOT NULL,
    nombre          NVARCHAR2(1000) NOT NULL
);

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_grupo ADD CONSTRAINT pk_egr PRIMARY KEY ( id_estado_grupo );

CREATE TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_menu (
    id_estado_menu NUMBER(19) NOT NULL,
    nombre         NVARCHAR2(1000) NOT NULL
);

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_menu ADD CONSTRAINT pk_esm PRIMARY KEY ( id_estado_menu );

CREATE TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_rol (
    id_estado_rol NUMBER(19) NOT NULL,
    nombre        NVARCHAR2(1000) NOT NULL
);

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_rol ADD CONSTRAINT pk_esr PRIMARY KEY ( id_estado_rol );

CREATE TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_seccional (
    id_estado_seccional NUMBER(19) NOT NULL,
    nombre              NVARCHAR2(1000) NOT NULL
);

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_seccional ADD CONSTRAINT pk_ess PRIMARY KEY ( id_estado_seccional );

CREATE TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_usuario (
    id_estado_usuario NUMBER(19) NOT NULL,
    nombre            NVARCHAR2(1000) NOT NULL
);

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.estado_usuario ADD CONSTRAINT pk_eus PRIMARY KEY ( id_estado_usuario );
...
CREATE TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.menusxrol (
    id_menu     NUMBER(19) NOT NULL,
...
ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.menusxrol ADD CONSTRAINT pk_mnr PRIMARY KEY ( id_menu,
                                                                                  id_rol );

CREATE TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.menusxrolxgrupo (
    id_menu   NUMBER(19) NOT NULL,
    id_rol    NUMBER(19) NOT NULL,
    id_grupo  NUMBER(19) NOT NULL,
    es_activo NUMBER(1) NOT NULL
...
ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.menusxrolxgrupo
...
ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.usuario
    ADD CONSTRAINT fk_dtu_usu FOREIGN KEY ( id_usuario )
        REFERENCES SCHQA_ORCL_DESARCHIVE_AUTEN.detalle_usuario ( id_detalle_usuario );

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.grupo
    ADD CONSTRAINT fk_egr_grp FOREIGN KEY ( id_estado_grupo )
        REFERENCES SCHQA_ORCL_DESARCHIVE_AUTEN.estado_grupo ( id_estado_grupo );

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.menu
    ADD CONSTRAINT fk_esm_men FOREIGN KEY ( id_estado_menu )
        REFERENCES SCHQA_ORCL_DESARCHIVE_AUTEN.estado_menu ( id_estado_menu );

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.rol
    ADD CONSTRAINT fk_esr_rol FOREIGN KEY ( id_estado_rol )
        REFERENCES SCHQA_ORCL_DESARCHIVE_AUTEN.estado_rol ( id_estado_rol );

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.seccional
    ADD CONSTRAINT fk_ess_scn FOREIGN KEY ( id_estado_seccional )
        REFERENCES SCHQA_ORCL_DESARCHIVE_AUTEN.estado_seccional ( id_estado_seccional );

ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.usuario
    ADD CONSTRAINT fk_eus_usu FOREIGN KEY ( id_estado_usuario )
        REFERENCES SCHQA_ORCL_DESARCHIVE_AUTEN.estado_usuario ( id_estado_usuario );
...
ALTER TABLE SCHQA_ORCL_DESARCHIVE_AUTEN.menusxrol
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.seq_cred START WITH 1 NOCACHE ORDER;
...
BEGIN
    :new.id_credencial := SCHQA_ORCL_DESARCHIVE_AUTEN.seq_cred.nextval;
END;
/
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.seq_estado_grupo START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER SCHQA_ORCL_DESARCHIVE_AUTEN.trg_estado_grupo BEFORE
    INSERT ON SCHQA_ORCL_DESARCHIVE_AUTEN.estado_grupo
    FOR EACH ROW
    WHEN ( new.id_estado_grupo IS NULL )
BEGIN
    :new.id_estado_grupo := SCHQA_ORCL_DESARCHIVE_AUTEN.seq_estado_grupo.nextval;
END;
/

CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.seq_estado_menu START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER SCHQA_ORCL_DESARCHIVE_AUTEN.trg_estado_menu BEFORE
    INSERT ON SCHQA_ORCL_DESARCHIVE_AUTEN.estado_menu
    FOR EACH ROW
    WHEN ( new.id_estado_menu IS NULL )
BEGIN
    :new.id_estado_menu := SCHQA_ORCL_DESARCHIVE_AUTEN.seq_estado_menu.nextval;
END;
/

CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.seq_esrol START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER SCHQA_ORCL_DESARCHIVE_AUTEN.trg_estado_rol BEFORE
    INSERT ON SCHQA_ORCL_DESARCHIVE_AUTEN.estado_rol
    FOR EACH ROW
    WHEN ( new.id_estado_rol IS NULL )
BEGIN
    :new.id_estado_rol := SCHQA_ORCL_DESARCHIVE_AUTEN.seq_esrol.nextval;
END;
/

CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.seq_estado_seccional START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER SCHQA_ORCL_DESARCHIVE_AUTEN.trg_estado_seccional BEFORE
    INSERT ON SCHQA_ORCL_DESARCHIVE_AUTEN.estado_seccional
    FOR EACH ROW
    WHEN ( new.id_estado_seccional IS NULL )
BEGIN
    :new.id_estado_seccional := SCHQA_ORCL_DESARCHIVE_AUTEN.seq_estado_seccional.nextval;
END;
/

CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.seq_esusu START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER SCHQA_ORCL_DESARCHIVE_AUTEN.trg_estado_usuario BEFORE
    INSERT ON SCHQA_ORCL_DESARCHIVE_AUTEN.estado_usuario
    FOR EACH ROW
    WHEN ( new.id_estado_usuario IS NULL )
BEGIN
    :new.id_estado_usuario := SCHQA_ORCL_DESARCHIVE_AUTEN.seq_esusu.nextval;
END;
/
