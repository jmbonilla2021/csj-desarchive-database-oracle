...
--                             OWNER          =	 SCHQA_ORCL_DESARCHIVE_AUTEN                         
--                             TABLESPACE_IDX =  ORCLQA_DESARCHIVE_AUTEN_IDX
-- PARÁMETROS DE SALIDA:       N/A
-- OBJETOS QUE LO REFERENCIAN  N/A
-- LIDER TÉCNICO:              Gabriel Duarte
-- FECHA:                      2021/09/27
-- REALIZADO POR:              INFORMATICA & TECNOLOGIA (iniciales líder I&T - iniciales del desarrollador)
