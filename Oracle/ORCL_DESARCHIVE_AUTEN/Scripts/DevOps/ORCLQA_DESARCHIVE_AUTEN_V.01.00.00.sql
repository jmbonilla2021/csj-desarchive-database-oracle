...
CREATE TABLESPACE ORCLQA_DESARCHIVE_AUTEN_DATA DATAFILE '&TABLESPACEDATA' SIZE 10m AUTOEXTEND ON NEXT 10m MAXSIZE UNLIMITED;
CREATE TABLESPACE ORCLQA_DESARCHIVE_AUTEN_IDX  DATAFILE '&TABLESPACEIDX'   SIZE 10m AUTOEXTEND ON NEXT 10m MAXSIZE UNLIMITED;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_APPS_INTERNAS START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_CARGO START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_CREDENCIAL START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_DEPARTAMENTO START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_DETALLE_USUARIO START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_GRUPO START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_MENU START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_MUNICIPIO START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_PERMISOSXMODULO START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_PERMISOSXMODULOXROL START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_ROL START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_SECCIONAL START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_TIPO_IDENTIFICACION START WITH 1 CACHE 100 ORDER;
...
CREATE SEQUENCE SCHQA_ORCL_DESARCHIVE_AUTEN.SEQ_USUARIO START WITH 1 CACHE 100 ORDER;
