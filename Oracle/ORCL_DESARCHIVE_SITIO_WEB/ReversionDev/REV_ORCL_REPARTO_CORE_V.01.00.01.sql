/*
-------------------------------------------------------------------------------------------------------------------------------
-- OBJETIVO                  : Reversion del script ORCL_REPARTO_CORE_01_00_01.sql
-- PARÁMETROS DE ENTRADA     : NA
-- PARÁMETROS DE SALIDA      : NA   
-- OBJETOS QUE LO REFERENCIAN: NA
-- LIDER TÉCNICO             :              
-- FECHAHORA                 : 2021/11/22
...
DROP TABLE AUDITORIA_OBJETOS;
DROP SEQUENCE SEQ_AUDITORIA_OBJETO;
DROP PROCEDURE PROC_AUDITA_OBJETOS;