...
CREATE TABLE SCH_ORCL_DESARCHIVE_SWEB.SOLICITUD (
...
ALTER TABLE SCH_ORCL_DESARCHIVE_SWEB.SOLICITUD ADD CONSTRAINT PK_SLC PRIMARY KEY ( ID_SOLICITUD );
...
ALTER TABLE SCH_ORCL_DESARCHIVE_SWEB.SOLICITUD
...
ALTER TABLE SCH_ORCL_DESARCHIVE_SWEB.PROCESO
    ADD CONSTRAINT FK_SLC_PRO FOREIGN KEY ( ID_SOLICITUD )
        REFERENCES SCH_ORCL_DESARCHIVE_SWEB.SOLICITUD ( ID_SOLICITUD );
...
CREATE SEQUENCE SCH_ORCL_DESARCHIVE_SWEB.SEQ_SOLICITUD START WITH 1 CACHE 100 ORDER;

CREATE OR REPLACE TRIGGER SCH_ORCL_DESARCHIVE_SWEB.TRG_SOLICITUD BEFORE
    INSERT ON SCH_ORCL_DESARCHIVE_SWEB.SOLICITUD
    FOR EACH ROW
    WHEN ( NEW.ID_SOLICITUD IS NULL )
BEGIN
    :NEW.ID_SOLICITUD := SCH_ORCL_DESARCHIVE_SWEB.SEQ_SOLICITUD.NEXTVAL;
END;
/
