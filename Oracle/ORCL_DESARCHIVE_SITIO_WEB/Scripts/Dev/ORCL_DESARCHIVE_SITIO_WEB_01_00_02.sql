...
CREATE TABLE SCH_ORCL_DESARCHIVE_SWEB.DETALLE_PAQUETE (
...
ALTER TABLE SCH_ORCL_DESARCHIVE_SWEB.DETALLE_PAQUETE ADD CONSTRAINT PK_DPQ PRIMARY KEY ( ID_DETALLE );
...
ALTER TABLE SCH_ORCL_DESARCHIVE_SWEB.DETALLE_PAQUETE
...
CREATE SEQUENCE SCH_ORCL_DESARCHIVE_SWEB.SEQ_DETALLE_PAQUETE START WITH 1 CACHE 20 ORDER;

CREATE OR REPLACE TRIGGER SCH_ORCL_DESARCHIVE_SWEB.TRG_DETALLE_PAQUETE BEFORE
    INSERT ON SCH_ORCL_DESARCHIVE_SWEB.DETALLE_PAQUETE
    FOR EACH ROW
    WHEN ( NEW.ID_DETALLE IS NULL )
BEGIN
    :NEW.ID_DETALLE := SCH_ORCL_DESARCHIVE_SWEB.SEQ_DETALLE_PAQUETE.NEXTVAL;
END;
/

CREATE SEQUENCE SCH_ORCL_DESARCHIVE_SWEB.SEQ_ESTADO_SOLICITUD START WITH 1 CACHE 20 ORDER;
...
CREATE SEQUENCE SCH_ORCL_DESARCHIVE_SWEB.SEQ_PROCESO START WITH 1 CACHE 20 ORDER;
...
CREATE SEQUENCE SCH_ORCL_DESARCHIVE_SWEB.SEQ_SOLICITUD_DES START WITH 1 CACHE 20 ORDER;
...
CREATE SEQUENCE SCH_ORCL_DESARCHIVE_SWEB.SEQ_SUJETO_PROCESAL START WITH 1 CACHE 20 ORDER;
