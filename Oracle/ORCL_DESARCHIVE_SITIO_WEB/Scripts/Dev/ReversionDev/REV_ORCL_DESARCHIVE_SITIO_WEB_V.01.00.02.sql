/*
-------------------------------------------------------------------------------------------------------------------------------
-- OBJETIVO                  : Script de reversion del script ORCL_DESARCHIVE_SITIO_WEB_01_00_02.sql
...
DECLARE
   ...
   IS
     ...
     INTO   v_sesion
     FROM   V$SESSION VS
     WHERE  USERNAME = 'SCH_ORCL_DESARCHIVE_SWEB';
...
BEGIN
	DBMS_SERVICE.stop_service('ORCL_DESARCHIVE_SWEB');
END;
/
BEGIN
	DBMS_SERVICE.delete_service('ORCL_DESARCHIVE_SWEB');
END;
/

DROP ROLE ROL_DESARCHIVE_SWEB;
DROP USER SCH_ORCL_DESARCHIVE_SWEB CASCADE;

DROP TABLESPACE ORCL_DESARCHIVE_SWEB_DATA INCLUDING CONTENTS;
DROP TABLESPACE ORCL_DESARCHIVE_SWEB_IDX  INCLUDING CONTENTS;