/*
-------------------------------------------------------------------------------------------------------------------------------
-- OBJETIVO                  : Script de reversion del script ORCL_REPARTO_CORE_01_00_02.sql
...
DECLARE
   ...
   IS
     ...
     INTO   v_sesion
     FROM   V$SESSION VS
     WHERE  USERNAME = 'SCH_ORCL_REPARTO_CORE';
...
BEGIN
	DBMS_SERVICE.stop_service('ORCL_REPARTO_CORE');
END;
/
BEGIN
	DBMS_SERVICE.delete_service('ORCL_REPARTO_CORE');
END;
/

DROP ROLE ROL_REPARTO_CORE;
DROP USER SCH_ORCL_REPARTO_CORE CASCADE;

DROP TABLESPACE ORCL_REPARTO_CORE_DATA INCLUDING CONTENTS;
DROP TABLESPACE ORCL_REPARTO_CORE_IDX  INCLUDING CONTENTS;