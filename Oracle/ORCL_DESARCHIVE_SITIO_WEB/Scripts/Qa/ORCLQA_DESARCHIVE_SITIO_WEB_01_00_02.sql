...
CREATE TABLE SCH_ORCLQA_DESARCHIVE_SWEB.SOLICITUD_DES (
    ...
    CODIGO_TIPO_PROCESO      NUMBER(19) NOT NULL,
    CODIGO_JUZGADO           NUMBER(19) NOT NULL,
    CODIGO_ESPECIALIDAD      NUMBER(19) NOT NULL,
    CODIGO_TIPO_DOCUMENTO    NUMBER(19) NOT NULL,
    ID_ESTADO_SOLICITUD      NUMBER(19) NOT NULL,
...
CREATE TABLE SCH_ORCLQA_DESARCHIVE_SWEB.SUJETO_PROCESAL (
    ...
    SEGUNDO_APELLIDO         NVARCHAR2(1000),
    CODIGO_TIPO_SUJ_PROCESAL NUMBER(19)
);
