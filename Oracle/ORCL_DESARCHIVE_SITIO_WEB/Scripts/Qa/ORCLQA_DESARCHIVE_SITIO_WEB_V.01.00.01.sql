...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE ROLE ROL_ORCLQA_DESARCHIVE_SWEB';
    PROC_AUDITA_OBJETOS(NULL,NULL,'CREA ROL OK.',NULL,NULL);
    EXECUTE IMMEDIATE 'GRANT CREATE SESSION, CREATE TABLE, CREATE SEQUENCE, CREATE VIEW, CREATE TRIGGER,CREATE PROCEDURE TO ROL_ORCLQA_DESARCHIVE_SWEB';
    ...
    EXECUTE IMMEDIATE 'GRANT ROL_ORCLQA_DESARCHIVE_SWEB TO '||V_USUARIO;
...
DECLARE
  ...
  IS 
    SELECT 'GRANT SELECT, INSERT, UPDATE, DELETE ON SCH_ORCLQA_DESARCHIVE_SWEB.'||TABLE_NAME||' TO ' AS SENTENCIA
		FROM   ALL_TABLES
    WHERE  OWNER = 'SCH_ORCLQA_DESARCHIVE_SWEB';
...
BEGIN
  ...
  V_ROL := 'ROL_ORCLQA_DESARCHIVE_SWEB';
  OPEN C_PERMISOS;
  LOOP
